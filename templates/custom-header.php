...
{
echo '<header class="page-row" role="banner">
                                ...
                                <div class="yamm-content" ng-controller="OneSearchCtrl">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form ng-submit="search()" class="onesearch-form">
                                                    <suggest-one-search prompt="Search journals, articles, books, website & more - POC Plugin was here" model="searchText" search="search"></suggest-one-search>
                                                </form>
                                            </div>
                                        </div>
                                        <div class="row">
